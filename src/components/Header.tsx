...
//                 return <Link href={`/${cname.replaceAll(' ', '-')}/builders-hardware-manufacturers`} 
//                 key={cname} className="image-container">
//                       <Image
//                         src={`/header/${cname}.png`}
//                         alt={`${cname}`}
...
//         </div>
//         <div className="dropdown">
//         <Link href={'/architectural-builders-hardware-fitting-materials'} className={'nav-links'}>
//             Material
//         </Link>
//         </div>
//       </div>
...
//           <Link href={'/architectural-builders-hardware-finishes'} className={'nav-links'}>
//             Finishes
//           </Link>
//         </div>
//         <div className="dropdown" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
...
//         </div>
//       </div>
//       <div className='mobile-quote-holder'>
//           <QuoteManager />
//       </div>
//     </div>
...
export function Header() {
  ...
  return (
    <>
      <div className={`header-menu style-one ${fixedHeader ? ' fixed' : 'relative'} bg-black w-full md:h-[74px] h-[56px]`}>
        <div className="container mx-auto h-full">
          <div className="header-main flex justify-between h-full">
            ...
            <div className="menu-main h-full max-lg:hidden">
              <ul className='flex items-center gap-8 h-full'>
                ...
                <li className='h-full'>
                  ...
                  <div className="mega-menu absolute top-[74px] left-0 bg-white w-screen flex h-[300px]">
                        {Object.keys(CATEGORIES[0]).map((cname) => {
                          return <Link href={`/${cname.replaceAll(' ', '-')}/builders-hardware-manufacturers`}
                            key={cname} className="">
                            <Image
            ...
            <div className="right flex gap-12">
              <div className="max-md:hidden flex items-center cursor-pointer relative">
                <button className='text-button-uppercase'>
                  YOUR QUOTE
                </button>
